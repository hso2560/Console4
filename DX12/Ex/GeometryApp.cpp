...
void GeometryApp::UpdateMainPassCB(const GameTimer& gt)
{
    ...
    //포인트 라이트
    mMainPassCB.Lights[0].Direction = { 0.9f, 0.9f, 0.9f };
    mMainPassCB.Lights[0].Position = { 0.0f, 5.0f, 5.0f };
    mMainPassCB.Lights[0].Direction = { 0.0f, -1.0f, 0.0f };
    mMainPassCB.Lights[0].FalloffStart = 10;
    mMainPassCB.Lights[0].FalloffEnd = 20;
    mMainPassCB.Lights[0].SpotPower = 64;

    //mMainPassCB.Lights[1].Direction = { 0.9f, 0.9f, 0.9f };
    //mMainPassCB.Lights[1].Position = { 0.0f, 5.0f, -5.0f };
...
void GeometryApp::BuildShadersAndInputLayout()
{
    ...
    HRESULT hr = S_OK;
    mShaders["standardVS"] = d3dUtil::CompileShader(TEXT("Shaders\\Default_Spot.hlsl"), nullptr, "VS", "vs_5_1");
    mShaders["opaquePS"] = d3dUtil::CompileShader(TEXT("Shaders\\Default_Spot.hlsl"), nullptr, "PS", "ps_5_1");
